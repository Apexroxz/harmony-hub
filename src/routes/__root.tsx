...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "SonicChain" },
      ...
      { name: "twitter:site", content: "@sonicchain" },
      { name: "twitter:title", content: "SonicChain — Web3 Music Streaming" },
      { name: "twitter:description", content: "Discover, stream, and collect music NFTs on Solana." },
